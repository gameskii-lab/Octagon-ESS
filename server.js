...
// Login endpoint - Validates user credentials against ERPNext
...
// Get today's shift assignment for an employee
...
app.post('/api/leave-application', async (req, res) => {
    ...
    try {
        const payload = {
            ...
            to_date: toDate,
            description: reason || 'Applied via ESS',
            leave_approver: '', // ERPNext will auto-assign based on workflow
            status: 'Open'
        };
